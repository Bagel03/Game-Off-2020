            ...
            for(var layer = 0; layer <= layers.length-1; layer++){
                ...
                for (var r = 0; r < this.map.height; r++) {
                  for (var c = 0; c < this.map.width; c++) {
                    ...
                    var tileTypeID = this.map.getTile(layer,c, r);//get tiletype in map at col, row for this layer
                    ...
                    if(tileTypeID!=0){
                        ...
                        var tilepos = this.map.getTilePositionFor(tileset, tileTypeID, layer);//returns {col,row,x,y}
